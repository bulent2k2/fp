...
------------------------------------------------------------------------------------------------------------------------------
-- Lab 2: Validating Credit Card Numbers -- More doc at the bottom! bbx.
------------------------------------------------------------------------------------------------------------------------------
...
-- convert a sequence of digits to the number it represents!
-- [0,0,1,0,2,0,0,3,0,0]-> 10200300
...
toDigitsRev n
  |  n < 0      = error "Negative number. Not a credit card number"
  |  n < 10     = [n]
...
doubleSecond []        = []
doubleSecond (n:ns)    = n : doubleFirst ns
  where 
    doubleFirst []     = []
    doubleFirst (m:ms) = 2*m : doubleSecond ms
...
-- bbx. FIRST, I DID SUM!: sum xs = foldr (\x y -> x+y) 0 xs
...
-- bbx TODO: use func composition!!
isValid :: Integer -> Bool
isValid n = 0 == mod ( sumDigits (doubleSecond ( toDigitsRev n ) )) 10

-- ===================================
-- Ex. 5
-- ===================================
    
-- bbx: TODO: how does this work??
